...
Generate music from prompts or reference audio, create or blend lyrics, produce stems, covers, music videos, voice validation phrases, and reusable custom voices with the Suno SDK. This skill helps Claude Code, Codex, Gemini CLI, Cursor, and 50+ agents integrate Suno through RunAPI.
