...
/** Task response base containing instruments. */
public class InstrumentsTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the instruments, when present. */
  public List<Map<String, Object>> getInstruments() {
    return instruments == null ? null : Collections.unmodifiableList(instruments);
  }
  ...
  public void ensureResultPresent() {
    if (instruments == null) {
      throw new ValidationException("completed task response is missing instruments");
    }
  }
