...
/** Task response base containing lyrics. */
public class LyricsTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the lyrics, when present. */
  public List<Map<String, Object>> getLyrics() {
    return lyrics == null ? null : Collections.unmodifiableList(lyrics);
  }
  ...
  public void ensureResultPresent() {
    if (lyrics == null) {
      throw new ValidationException("completed task response is missing lyrics");
    }
  }
