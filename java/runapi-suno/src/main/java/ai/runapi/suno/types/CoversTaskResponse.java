...
/** Task response base containing generated cover image results. */
public class CoversTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the generated cover image results, when present. */
  public List<Image> getCovers() {
    return covers == null ? null : Collections.unmodifiableList(covers);
  }
  ...
  public void ensureResultPresent() {
    if (covers == null) {
      throw new ValidationException("completed task response is missing covers");
    }
  }
