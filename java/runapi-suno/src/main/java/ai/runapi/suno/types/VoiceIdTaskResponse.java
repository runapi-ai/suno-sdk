...
/** Task response base containing voice ID. */
public class VoiceIdTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the voice ID, when present. */
  ...
  public void ensureResultPresent() {
    if (voiceId == null) {
      throw new ValidationException("completed task response is missing voice_id");
    }
  }
