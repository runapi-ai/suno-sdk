...
/** Task response base containing video URL. */
public class VideoUrlTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the video URL, when present. */
  ...
  public void ensureResultPresent() {
    if (videoUrl == null) {
      throw new ValidationException("completed task response is missing video_url");
    }
  }
