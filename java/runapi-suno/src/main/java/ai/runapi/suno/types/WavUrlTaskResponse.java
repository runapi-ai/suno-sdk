...
/** Task response base containing wav URL. */
public class WavUrlTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the wav URL, when present. */
  ...
  public void ensureResultPresent() {
    if (wavUrl == null) {
      throw new ValidationException("completed task response is missing wav_url");
    }
  }
