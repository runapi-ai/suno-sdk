...
/** Task response base containing validation phrase. */
public class ValidationPhraseTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  @JsonProperty("validation_phrase")
  private String validationPhrase;
  ...
  /** Returns the validation phrase, when present. */
  public String getValidationPhrase() {
  ...
  public void ensureResultPresent() {
    if (validationPhrase == null) {
      throw new ValidationException("completed task response is missing validation_phrase");
    }
  }
