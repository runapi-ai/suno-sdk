...
/** Task response base containing track. */
public class TrackTaskResponse extends AbstractTaskResponse implements Poller.CompletedResult {
  @JsonProperty("id")
  private String id;
  ...
  /** Returns the track, when present. */
  ...
  public void ensureResultPresent() {
    if (track == null) {
      throw new ValidationException("completed task response is missing track");
    }
  }
