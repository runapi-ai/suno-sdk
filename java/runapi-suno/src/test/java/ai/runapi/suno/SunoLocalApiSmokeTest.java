...
import ai.runapi.suno.types.TextToSoundResponse;
    ...
    class SunoLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/suno/text_to_sound", this::handleRequest);
        server.start();
      }
      ...
      CompletedTextToSoundResponse response =
        ...
        assertEquals("/api/v1/suno/text_to_sound", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/suno/text_to_sound/task_local_123", captured.path);
